...
This repository is a fork of the **Video Downloader** Raycast extension by
[vimtor](https://github.com/vimtor) and its contributors, from the
[raycast/extensions](https://github.com/raycast/extensions/tree/main/extensions/video-downloader)
monorepo. Used under the MIT License — see [LICENSE](LICENSE).
