...
## [Fix: Download Correctness + CI] - {PR_MERGE_DATE}
...
- **CI**: added a GitHub Actions workflow running the unit tests, `ray build` (which includes the TypeScript check), ESLint, and Prettier on every push and pull request.
