...
- Download videos and audio from YouTube, Reddit, and hundreds of other sites via yt-dlp.
- Download image galleries via gallery-dl, with support for reading cookies from your browser for login-gated sites.
- Download Spotify tracks, albums, and playlists via spotDL.
